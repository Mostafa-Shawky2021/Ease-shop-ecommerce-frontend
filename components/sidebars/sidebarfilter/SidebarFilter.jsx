							...
							<div className={style.filter}>
								...
								<ul className={`list-unstyled ${style.filterList}`}>
									{productVariants.brands.map((brand) => {
										const activeFilterRule = filterRules.brands?.includes(brand.brand_name)
											? "checked"
											: "";
										return (
											<li
							...
							<div className={style.filter}>
								...
								<ul className={`list-unstyled ${style.filterList}`}>
									{productVariants.sizes.map((size) => {
										const activeFilterRule = filterRules.sizes.includes(size.size_name)
											? "checked"
											: "";
										return (
							...
							<div className={style.filter}>
								...
								<ul className={`list-unstyled ${style.filterList}`}>
									{productVariants.colors.map((color) => {
										const activeFilterRule = filterRules.colors.includes(color.color_name)
											? "checked"
											: "";
										return (
											<li

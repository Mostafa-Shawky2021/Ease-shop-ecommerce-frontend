...
const Footer = () => {
  ...
  const renderAboutus = () => {
    const renderTextApi =
      footerData?.aboutus ||
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi ex culpa deleniti sapiente nisi voluptatem nemo reiciendis quibusdam sequi eveniet. Labore soluta dolore quae quidem, beatae nostrum autem esse veritatis.";
    if (isLoading)
      return (
        <CircularProgress
          size={18}
  ...
  const renderWhatsappLink = () => {
    const link = footerData?.whatsapp_number
      ? `https://wa.me/${footerData?.whatsapp_number}`
      : "https://wa.me/01017118755";
    return link;
  };
  const renderTwitterLink = () => footerData?.twitter_link || "#s";
  ...
  const renderEmail = () => {
    ...
    return footerData?.gmail_link || "mostafashawky20177@gmail.com";
  };
  ...
  return (
    <div className={style.footerWrapper}>
      <Container fluid="md">
        <Row>
          <Col xs={12} sm={8} md={6} lg={5} className={style.colWrapper}>
          ...
          <Col xs={12} sm={4} md={3} lg={2} className={style.colWrapper}>
          ...
          <Col xs={12} sm={8} md={3} lg={2} className={style.colWrapper}>
            <div className={style.usefullink}>
          ...
          <Col xs={12} sm={4} md={12} lg={3} className={style.colWrapper}>
            <div className={style.usefullink}>
              <h4 className={style.subtitle}>معلومات المتجر</h4>
              <ul
                className={`${style.linkslist} ${style.contactList} list-unstyled px-0`}
              >
                <li className={style.item}>
      ...
      <p
        className="text-center bg-black py-2 m-0 mt-3 mb-4 mb-lg-0"
        style={{ direction: "ltr" }}
      >
        Developed By{" "}
        <span className="text-danger">
          <Link href="https://www.linkedin.com/in/mostafa-ibrahim1/">
            Mostafa Shawky
          </Link>
        </span>
      </p>

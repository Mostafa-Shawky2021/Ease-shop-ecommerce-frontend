...
const ModalformOrder = ({ quantity, product, renderButton }) => {
  ...
  const handleSubmit = (event) => {
    ...
    if (validateForm(orderDetails)) sendFastOrder(orderDetails);
  };
            ...
            <Form onSubmit={handleSubmit}>
              ...
              >
                <div className="d-flex align-items-center">
                  <Form.Label className={style.labelControl}>
                    اسم المستخدم
                  </Form.Label>
                  <span
                ...
                <Form.Control
                  ...
                  className={`${style.formControl} ${
                    formErrorMsg.username ? style.errorField : ""
                  }`}
                  autoComplete="off"
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="phone">
                ...
                <Form.Control
                  ...
                  type="number"
                  className={`${style.formControl} ${
                    formErrorMsg.phone ? style.errorField : ""
                  }`}
                />
              </Form.Group>
              <Form.Group className="mb-3" controlId="governorate">
                <div className="d-flex align-items-center">
                  ...
                  <span className={style.errMsg}>
                    {formErrorMsg.governorate}
                  </span>
                </div>
                <Form.Select
                  name="governorate"
                  className={`${style.formControl} ${
                    formErrorMsg.governorate ? style.errorField : ""
                  }}`}
                >
                  <option value="">...</option>
              ...
              <Form.Group className="mb-3" controlId="street">
                ...
                <Form.Control
                  ...
                  type="text"
                  className={`${style.formControl} ${
                    formErrorMsg.street ? style.errorField : ""
                  }`}
                />
              </Form.Group>
